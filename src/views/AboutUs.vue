<template>
  ...
  >
    ...
    <v-row no-gutters class="temp-border__item ma-3 pa-3">
      <p v-text="secondRow.p1" class="text-body-1"></p>

      <p v-text="secondRow.p2" class="text-body-1"></p>

      <p v-text="secondRow.p3" class="text-body-1"></p>
    </v-row>
...
export default {
  ...
  data: () => ({
    ...
    secondRow: {
      p1: `ATA is the nation’s foremost and trusted organization committed to
      ...
      p2: `Since 1971, the American Tinnitus Association has been a global leader
        ...
        research.`,
      p3: `As a registered 501(c)(3) non-profit association, ATA is driven to
  ...
  methods: {
    scrollToTop() {
      if (this.exactRouteIsAbout) {
        scrollToTopUtil(this, "about-view");
      } else {
        scrollToTopUtil(this, "about-view_router-view");
      }
    },
  },
};
